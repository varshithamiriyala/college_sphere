  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogTrigger asChild>
        <Button
          variant="outline"
          className="flex h-full flex-col items-center justify-center gap-2 p-4 transition-all hover:shadow-md hover:-translate-y-1 bg-pink-100 hover:bg-pink-200 border-pink-200"
        >
          <Upload className="h-8 w-8 text-pink-600" />
          <span className="mt-2 text-center text-sm font-medium text-pink-800">Upload Data</span>
        </Button>
      </DialogTrigger>
